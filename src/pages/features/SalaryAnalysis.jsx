        ...
        <Layout style={{ minHeight: '100vh', background: 'var(--bg-page)', padding: '40px 24px' }}>
            <Content style={{ maxWidth: '1100px', margin: '0 auto', width: '100%' }}>
                ...
                <Row gutter={[24, 24]}>
                    <Col xs={24} lg={12}>
                        <Card
                            title={<Space style={{ color: '#FFFFFF' }}><SolutionOutlined /> Current Salary Structure</Space>}
                            style={{ borderRadius: '24px', border: 'none', boxShadow: 'var(--card-shadow)', background: 'var(--bg-card)' }}
                        >
                            <Table columns={columns} dataSource={currentStructure} pagination={false} style={{ borderRadius: '12px', overflow: 'hidden' }} />
                            <div style={{ marginTop: '24px', padding: '20px', background: 'var(--bg-page)', borderRadius: '16px', textAlign: 'center' }}>
                    ...
                    <Col xs={24} lg={12}>
                        <Card
                            ...
                            style={{ borderRadius: '24px', border: '2px dashed var(--success)', background: 'var(--bg-card)' }}
                        >
                ...
                <div style={{ marginTop: '40px' }}>
                    <Card style={{ borderRadius: '24px', background: 'var(--accent-primary)', color: '#FFFFFF' }}>
                            ...
                            <Col xs={24} md={12}>
                                <Space size={12} align="start" style={{ marginBottom: '16px' }}>
                                    ...
                                    <div>
                                        ...
                                        <Text style={{ color: 'rgba(255,255,255,0.85)', fontSize: '13px' }}>Keeping basic pay at 40% reduces the taxable component for HRA and PF efficiently.</Text>
                                    </div>
                                </Space>
                            </Col>
                            <Col xs={24} md={12}>
                                <Space size={12} align="start" style={{ marginBottom: '16px' }}>
                                    ...
                                    <div>
                                        ...
                                        <Text style={{ color: 'rgba(255,255,255,0.85)', fontSize: '13px' }}>Claiming vehicle maintenance as a flex-benefit reduces taxable gross significantly.</Text>
                                    </div>
                                </Space>
                            </Col>
                        </Row>
                ...
                <div style={{ marginTop: '40px', textAlign: 'center' }}>
                    <Text type="secondary" style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Note: Suggested structure may require discussion with your Employer HR / Payroll team.</Text>
                </div>
